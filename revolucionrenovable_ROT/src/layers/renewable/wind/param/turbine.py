                                ...
                                [
                                    html.Div(
                                        [
                                            ...
                                            dcc.Input(id='wind_turbine_rated_power', value=self.wind_turbine_rated_power, type='number', style=style_input)
                                        ], style={'display': 'flex'}),

                                    html.Div(
                                        [
                                            html.Label('Rotor Diameter [m]: ', style=style_label),
                                            dcc.Input(id='wind_turbine_rotor_diameter', value=self.wind_turbine_rotor_diameter, type='number', style=style_input)
                                        ], style={'display': 'flex'}),

                                    html.Div(
                                        [
                                            html.Label('Hub Height [m]: ', style=style_label),
                                            dcc.Input(id='wind_turbine_hub_height', value=self.wind_turbine_hub_height, type='number', style=style_input)
                                        ], style={'display': 'flex'}),

                                    html.Div(
                                        [
                                            html.Label('Cut-in Wind Speed [m/s]: ', style=style_label),
                                            dcc.Input(id='wind_turbine_v_cut_in',
                                                      value=self.wind_turbine_v_cut_in, type='number',
                                                      style=style_input)
                                        ], style={'display': 'flex'}),
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.Input(id='wind_turbine_v_rated',
                                                      value=self.wind_turbine_v_rated, type='number',
                                                      style=style_input)
                                        ], style={'display': 'flex'}),
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            dcc.Input(id='wind_turbine_v_cut_out', value=self.wind_turbine_v_cut_out,
                                                      type='number', style=style_input)
                                        ], style={'display': 'flex'}),
